...
## tested things out and found that this is able to take jpgs sent over tcp 
mypart = "tcpclientsrc port=20001 ! jpegdec ! videoconvert" 
...
factory.set_launch(f'( {mypart} ! x264enc speed-preset=ultrafast tune=zerolatency ! rtph264pay name=pay0 pt=96 )')
